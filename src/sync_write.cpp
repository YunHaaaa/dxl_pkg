...
//    uint32_t dxl_goal_position_r = 0;

//    int
//    //int dxl_goal_position[2] = { 1024, 3072 };
//    dxl_goal_position[2]

//    dxl_goal_position_cos_1 = (((dxl_goal_position[1]-dxl_goal_position[0]) / 2) * (1-cos(2 * 3.14 * t / T))) + dxl_goal_position[0];
//    dxl_goal_position_r = (dxl_goal_position[1]-dxl_goal_position[0]) * t/T;

//    // motor1
//    param_goal_position[0] = DXL_LOBYTE(DXL_LOWORD(dxl_goal_position_cos_1));
//    param_goal_position[1] = DXL_HIBYTE(DXL_LOWORD(dxl_goal_position_cos_1));

//    // motor2
//    param_goal_position[2] = DXL_LOBYTE(DXL_HIWORD(dxl_goal_position_r));
//    param_goal_position[3] = DXL_HIBYTE(DXL_HIWORD(dxl_goal_position_r));
